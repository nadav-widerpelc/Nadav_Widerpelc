<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:0969DA,100:00B4D8&height=190&section=header&text=Nadav%20Arik%20Widerpelc&fontSize=38&fontColor=FFFFFF&animation=fadeIn&fontAlignY=36&desc=Engenharia%20de%20Software%20%7C%20Automa%C3%A7%C3%A3o%20%7C%20IA&descSize=17&descAlignY=58" alt="Banner de Nadav Arik Widerpelc" />
...
[![Localização](https://img.shields.io/badge/Curitiba%2C%20PR-Brasil-0969DA?style=flat-square&logo=googlemaps&logoColor=white)](https://www.google.com/maps/place/Curitiba,+PR/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Nadav%20Widerpelc-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nadav-arik-widerpelc-904407284/)
[![GitHub](https://img.shields.io/badge/GitHub-nadav--widerpelc-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/nadav-widerpelc)
...
```mermaid
flowchart LR
    A[Cliente publica a demanda] --> B[Freelancer encontra o serviço]
    B --> C[Conversa e alinhamento]
    C --> D[Execução do projeto]
...
```mermaid
flowchart TD
    A[Cliente envia o formulário] --> B[n8n recebe a solicitação]
    B --> C[Validação do cadastro]
    C --> D[IA classifica o atendimento]
    D --> E{Categoria identificada}
    E -->|Documento| F[Busca no Drive e envia por e-mail]
    E -->|Financeiro| G[Cria pendência e alerta]
    E -->|Assistência 24h| H[Encaminha alerta humano urgente]
    E -->|Outro| I[Envia para triagem manual]
    F --> J[Registra o atendimento no Sheets]
    G --> J
    H --> J
    I --> J
```
